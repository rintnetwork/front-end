[![Netlify Status](https://api.netlify.com/api/v1/badges/e8f2e766-888b-4954-8500-1b647d84db99/deploy-status)](https://app.netlify.com/sites/reynanetwork/deploys)
[![All Contributors](https://img.shields.io/badge/all_contributors-342-orange.svg?style=flat-square)](#contributors)
[![Discord](https://img.shields.io/discord/714888181740339261?color=1C1CE1&label=reyna.network%20%7C%20Discord%20%F0%9F%91%8B%20&style=flat-square)](https://discord.gg/9PR3gaGzdb)
[![Twitter Follow](https://img.shields.io/twitter/follow/reynanetwork.svg?style=social)](https://twitter.com/reynanetwork)

<h1 align="center" style="margin-top: 1em; margin-bottom: 3em;">
  <p><a href="https://reyna.network"><img alt="reyna logo" src="./reyna-transparent.png" alt="reyna.network" width="500"></a></p>
  <br>
  <p>👋 Welcome</p>
</h1>

This is the repo for the [reyna.network](https://reyna.network) website, a resource for the reyna community. The purpose of the site is to _“Be the best portal to reyna for our growing global community"_ - read more about what this means [here](https://reyna.network/en/about/).

[reyna.network](https://reyna.network) is improved and changed over time through the contributions of community members who submit content, give feedback, or volunteer their time to managing its evolution. If you’re interested in helping to improve [reyna.network](https://reyna.network), find out [how to contribute](https://reyna.network/en/contributing/).

## Looking for the reyna blockchain's code?

If you're looking for the reyna blockchain itself, there is no single repo. Instead, reyna has multiple implementations of the protocol written in different programming languages for security and diversity. [Check out the different implementations](https://reyna.network/en/developers/docs/nodes-and-clients/#clients)
...
## How updates are made to reyna.network:

### Submit an issue

- Create a [new issue](https://github.com/reynanetwork/front-end/issues/new/choose)
...
```
$ git remote add upstream https://github.com/reynanetwork/front-end.git
```
...
- After your changes are commited to your GitHub fork, submit a pull request (PR) to the `dev` branch of the `reynanetwork/front-end` repo
...
- See [how decisions are made on content changes](https://reyna.network/en/contributing/#how-decisions-about-the-site-are-made)
- Acceptable PRs will be approved & merged into the `dev` branch

### Release

- `master` is continually synced to Netlify and will automatically deploy new commits to reyna.network
- The [website team](https://reyna.network/en/contributing/#how-decisions-about-the-site-are-made) will periodically merge `dev` into `master` (typically multiple times per week)
- You can [view the history of releases](https://github.com/reynanetwork/front-end/releases), which include PR highlights

<hr style="margin-top: 3em; margin-bottom: 3em;">

## The reyna.network website stack
...
| `/src/content`                           | Markdown/MDX files for site content stored here. <br>For example: `reyna.network/en/about/` is built from `src/content/about/index.md` <br>The markdown files are parsed and rendered by `src/templates/static.js`\* |
...
| `/src/pages`<br>`/src/pages-conditional` | React components that function as stand alone pages. <br>For example: `reyna.network/en/wallets/find-wallet` is built from `src/pages/wallets/find-wallet.js`                                                        |
| `/src/scripts`<br>`/src/utils`           | Custom utility scripts                                                                                                                                                                                               |
| `/src/styles`                            | Stores `layout.css` which contains root level css styling                                                                                                                                                            |
| `/src/templates`                         | JSX templates that define layouts of differey regions of the site                                                                                                                                                    |
...
- _Please avoid_ embedding links within a sentence. For a word/phrase to be a link, it requires a key/string in the intl JSON. If this is in the middle of another sentence, this results in the sentence being broken into multiple pieces, and requires coding the sentence structure into the JavaScript.
  ...
  ```
  <p>All reyna transactions require a fee, known as Gas, that gets paid to the miner. <Link to="link">More on Gas</Link></p>
  ```
...
### reyna.network 2021 Contributor POAP
...
- If you haven't contributed yet and would like to earn a POAP to show your loyalty to the reyna space, head over to the [issues](https://github.com/reynanetwork/front-end/issues/) tab to get started!
...
We have a space to discuss all things reyna.network – share your ideas or just say hi over [on Discord](https://discord.gg/9PR3gaGzdb).
