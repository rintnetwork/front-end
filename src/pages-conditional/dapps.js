...
const DappsPage = ({ data, location }) => {
  ...
  const features = [
    {
      title: translateMessageId("reyna-page-dapps-features-1-title", intl),
      description: translateMessageId(
        "reyna-page-dapps-features-1-description",
        intl
      ),
      emoji: ":bust_in_silhouette:",
    },
    {
      title: translateMessageId("reyna-page-dapps-features-2-title", intl),
      description: translateMessageId(
        "reyna-page-dapps-features-2-description",
        intl
      ),
      emoji: ":megaphone:",
    },
    {
      title: translateMessageId("reyna-page-dapps-features-3-title", intl),
      description: translateMessageId(
        "reyna-page-dapps-features-3-description",
        intl
      ),
      emoji: ":money-mouth_face:",
    },
    {
      title: translateMessageId("reyna-page-dapps-features-4-title", intl),
      description: translateMessageId(
        "reyna-page-dapps-features-4-description",
        intl
      ),
      emoji: ":electric_plug:",
    },
    {
      title: translateMessageId("reyna-page-dapps-features-5-title", intl),
      description: translateMessageId(
        "reyna-page-dapps-features-5-description",
        intl
      ),
      emoji: ":detective:",
    },
    {
      title: translateMessageId("reyna-page-dapps-features-6-title", intl),
      description: translateMessageId(
        "reyna-page-dapps-features-6-description",
        intl
      ),
      emoji: ":key:",
    },
    {
      title: translateMessageId("reyna-page-dapps-features-7-title", intl),
      description: translateMessageId(
        "reyna-page-dapps-features-7-description",
        intl
      ),
  ...
  const categories = {
    finance: {
      title: translateMessageId("reyna-page-dapps-finance-button", intl),
      emoji: ":money_with_wings:",
      benefitsTitle: translateMessageId(
        "reyna-page-dapps-finance-benefits-title",
        intl
      ),
      benefitsDescription: translateMessageId(
        "reyna-page-dapps-finance-benefits-description",
        intl
      ),
      benefits: [
        {
          ...
          title: translateMessageId(
            "reyna-page-dapps-finance-benefits-1-title",
            intl
          ),
          description: translateMessageId(
    ...
    collectibles: {
      title: translateMessageId("reyna-page-dapps-collectibles-button", intl),
    ...
    gaming: {
      title: translateMessageId("reyna-page-dapps-gaming-button", intl),
      emoji: ":video_game:",
      benefitsTitle: translateMessageId(
    ...
    technology: {
      title: translateMessageId("reyna-page-dapps-technology-button", intl),
      emoji: ":keyboard:",
    },
  }
  ...
  const investments = [
    {
      ...
      link: "https://exchange.reyna.network/",
      image: data.reynaexchange.childImageSharp.fluid,
      alt: translateMessageId("reyna-page-dapps-token-exchange-logo-alt", intl),
    },
  ]
  ...
  const utilities = [
    {
      ...
      link: "https://messenger.reyna.network/",
      image: data.reynamessenger.childImageSharp.fluid,
      alt: translateMessageId("reyna-page-dapps-messenger-logo-alt", intl),
    },
  ]

  const music = [
    {
      title: "reyna Foundation",
      description: translateMessageId(
        "reyna-page-dapps-description-foundation",
        intl
      ),
      link: "https://foundation.reyna.network/",
      image: data.reynafoundation.childImageSharp.fluid,
      alt: translateMessageId("reyna-page-dapps-foundation-logo-alt", intl),
    },
  ]
  ...
  const worlds = [
    {
      title: "reyna Casino",
      description: translateMessageId(
        "reyna-page-dapps-description-casino",
        intl
      ),
      link: "https://casino.reyna.network/",
      image: data.reynacasino.childImageSharp.fluid,
      alt: translateMessageId("reyna-page-dapps-casino-logo-alt", intl),
    },
  ]

  const heroContent = {
    title: translateMessageId("decentralized-applications-dapps", intl),
    header: translateMessageId("reyna-page-dapps-hero-header", intl),
    subtitle: translateMessageId("reyna-page-dapps-hero-subtitle", intl),
    image: data.getdapp.childImageSharp.fluid,
    alt: translateMessageId("reyna-page-dapps-getdapp-img-alt", intl),
    buttons: [
      {
        content: translateMessageId(
          "reyna-page-dapps-explore-dapps-title",
          intl
        ),
        path: "#explore",
      },
      {
        content: translateMessageId("reyna-page-dapps-what-are-dapps", intl),
        path: "#what-are-dapps",
  ...
  return (
    <Page>
      ...
      <Content>
        <H2>
          <Translation id="reyna-get-started" />
        </H2>
        <p>
          <Translation id="reyna-page-dapps-get-started-subtitle" />{" "}
        ...
        <Row>
          <StepBoxContainer>
            ...
            <StepBox to="/wallets/find-wallet/">
              <div>
                <H3>
                  2. <Translation id="reyna-page-dapps-set-up-a-wallet-title" />
                </H3>
                <p>
                  <Translation id="reyna-page-dapps-set-up-a-wallet-description" />
                </p>
              </div>
              <StyledButtonSecondary>
                <Translation id="reyna-page-dapps-set-up-a-wallet-button" />
              </StyledButtonSecondary>
            </StepBox>
            <StepBox to="#explore">
              <div>
                <H3>
                  3. <Translation id="reyna-page-dapps-ready-title" />
                </H3>
                <p>
                  <Translation id="reyna-page-dapps-ready-description" />
                </p>
              </div>
              <ButtonPrimary>
                <Translation id="reyna-page-dapps-ready-button" />
              </ButtonPrimary>
            </StepBox>
          </StepBoxContainer>
        </Row>
      ...
      <FullWidthContainer ref={explore}>
        <h2 id="explore">
          <Translation id="reyna-page-dapps-explore-dapps-title" />
        </h2>
        <CenterText>
          <Translation id="reyna-page-dapps-explore-dapps-description" />
        </CenterText>
        <h3>
          <Translation id="reyna-page-dapps-choose-category" />
        </h3>
        <OptionContainer>
        ...
        {selectedCategory === FINANCE && (
          <Content>
            <IntroRow>
              <Column>
                <H2>
                  <Translation id="reyna-page-dapps-finance-title" />{" "}
                  <Emoji
                    size={"2rem"}
                    ml={"0.5rem"}
                ...
                <Subtitle>
                  <Translation id="reyna-page-dapps-finance-description" />
                </Subtitle>
              </Column>
              <StyledInfoBanner isWarning={true}>
                <H2>
                  <Translation id="reyna-page-dapps-warning-header" />
                </H2>
                <Translation id="reyna-page-dapps-warning-message" />
              </StyledInfoBanner>
            </IntroRow>
              ...
              <LeftColumn>
                <ProductList
                  category={translateMessageId(
                    "reyna-page-dapps-category-exchange",
                    intl
                  )}
                  content={investments}
                />
        ...
        {selectedCategory === GAMING && (
          <Content>
            <IntroRow>
              <Column>
                <H2>
                  <Translation id="reyna-page-dapps-gaming-title" />{" "}
                  <Emoji size={"2rem"} ml={"0.5rem"} text=":video_game:" />
                </H2>
                <Subtitle>
                  <Translation id="reyna-page-dapps-gaming-description" />
                </Subtitle>
              </Column>
              <StyledInfoBanner isWarning={true}>
                <H2>
            ...
            <TwoColumnContent>
              <LeftColumn>
                <ProductList
                  category={translateMessageId(
                    "reyna-page-dapps-category-casino",
                    intl
                  )}
                  content={worlds}
                />
        ...
        {selectedCategory === TECHNOLOGY && (
          <Content>
            <IntroRow>
              <Column>
                <H2>
                  <Translation id="reyna-page-dapps-technology-title" />{" "}
                  <Emoji size={"2rem"} ml={"0.5rem"} text=":keyboard:" />
                </H2>
                <Subtitle>
                  <Translation id="reyna-page-dapps-technology-description" />
                </Subtitle>
              </Column>
              <StyledInfoBanner isWarning={true}>
                <H2>
            ...
            <TwoColumnContent>
              <LeftColumn>
                <ProductList
                  category={translateMessageId(
                    "reyna-page-dapps-category-technology",
                    intl
                  )}
                  content={utilities}
                />
        ...
        {selectedCategory === COLLECTIBLES && (
          <Content>
            <IntroRow>
              <Column>
                <H2>
                  <Translation id="reyna-page-dapps-collectibles-title" />{" "}
                  <Emoji
                    size={"2rem"}
                    ml={"0.5rem"}
                ...
                <Subtitle>
                  <Translation id="reyna-page-dapps-collectibles-description" />
                </Subtitle>
              </Column>
              <StyledInfoBanner isWarning={true}>
                <H2>
            ...
            <TwoColumnContent>
              <LeftColumn>
                <ProductList
                  category={translateMessageId(
                    "reyna-page-dapps-category-foundation",
                    intl
                  )}
                  content={music}
                />
        ...
        <MobileOptionContainer>
          <h3>
            <Translation id="reyna-page-dapps-mobile-options-header" />
          </h3>
          {categoryKeys.map((key, idx) => {
            const category = categories[key]
            return (
      ...
      <Content>
        <ImageContainer id="reyna-page-dapps-what-are-dapps">
          <StyledGhostCard>
            <MagiciansImage
        ...
        <Box>
          <h2>
            <Translation id="reyna-page-dapps-magic-behind-dapps-title" />
          </h2>
          <BoxText>
            <Translation id="reyna-page-dapps-magic-behind-dapps-description" />
          </BoxText>
          <Link to="/what-is-ethereum/">
            <Translation id="reyna-page-dapps-magic-behind-dapps-link" />
          </Link>
        </Box>
        ...
        <Row>
          <LeftColumn>
            <h2>
              <Translation id="reyna-page-dapps-how-dapps-work-title" />
            </h2>
            <p>
              <Translation id="reyna-page-dapps-how-dapps-work-p1" />
            </p>
            <p>
              <Translation id="reyna-page-dapps-how-dapps-work-p2" />
            </p>
            <p>
              <Translation id="reyna-page-dapps-how-dapps-work-p3" />
            </p>
            <StyledDocLink
          ...
          <RightColumn>
            <StyledCallout
              title={translateMessageId(
                "reyna-page-dapps-learn-callout-title",
                intl
              )}
              description={translateMessageId(
                "reyna-page-dapps-learn-callout-description",
                intl
              )}
            ...
            >
              <div>
                <ButtonLink to="/contributing/">
                  <Translation id="reyna-page-dapps-contributing-button" />
                </ButtonLink>
              </div>
            </StyledCallout>
          </RightColumn>
...
export const query = graphql`
  query {
    ...
    magicians: file(relativePath: { eq: "reyna-magicians.png" }) {
      childImageSharp {
        fluid(maxWidth: 300) {
          ...GatsbyImageSharpFluid
        }
    ...
    reynaexchange: file(relativePath: { eq: "dapps/reyna-exchange.png" }) {
      ...dappImage
    }
    reynafoundation: file(relativePath: { eq: "dapps/reyna-foundation.png" }) {
      ...dappImage
    }
    reynacasino: file(relativePath: { eq: "dapps/reyna-casino.png" }) {
      ...dappImage
    }
    reynamessenger: file(relativePath: { eq: "dapps/reyna-messenger.png" }) {
      ...dappImage
    }
  }
`
