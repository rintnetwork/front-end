...
const HomePage = ({ data }) => {
  ...
  const cards = [
    {
      ...
      title: translateMessageId(
        "reyna-page-index-get-started-wallet-title",
        intl
      ),
      description: translateMessageId(
        "reyna-page-index-get-started-wallet-description",
        intl
      ),
      alt: translateMessageId(
        "reyna-page-index-get-started-wallet-image-alt",
        intl
      ),
    ...
    },
    {
      ...
      title: translateMessageId(
        "reyna-page-index-get-started-dapps-title",
        intl
      ),
      description: translateMessageId(
        "reyna-page-index-get-started-dapps-description",
        intl
      ),
      alt: translateMessageId(
        "reyna-page-index-get-started-dapps-image-alt",
        intl
      ),
      to: "/dapps/",
    },
    {
      ...
      alt: translateMessageId(
        "reyna-page-index-get-started-devs-image-alt",
        intl
      ),
      to: "/developers/",
    },
  ...
  const touts = [
    ...
    },
    {
      ...
      alt: translateMessageId(
        "reyna-page-index-tout-enterprise-image-alt",
        intl
      ),
      title: translateMessageId("reyna-page-index-tout-enterprise-title", intl),
      description: translateMessageId(
        "reyna-page-index-tout-enterprise-description",
        intl
      ),
      to: "/enterprise/",
    },
  ...
  const codeExamples = [
    {
      title: translateMessageId(
        "reyna-page-index-developers-code-example-title-0",
        intl
      ),
      description: translateMessageId(
        "reyna-page-index-developers-code-example-description-0",
        intl
      ),
...
contract SimpleWallet {
  ...
  // When this contract is deployed, set the deploying address as the owner of the contract.
    ...
    {
      title: translateMessageId(
        "reyna-page-index-developers-code-example-title-1",
        intl
      ),
      description: translateMessageId(
        "reyna-page-index-developers-code-example-description-1",
        intl
      ),
      codeLanguage: "language-solidity",
      code: `// SPDX-License-Identifier: MIT
...
contract SimpleToken {
  ...
  // 2. set the token balance of the owner to the total token supply
    ...
    {
      title: translateMessageId(
        "reyna-page-index-developers-code-example-title-2",
        intl
      ),
      description: translateMessageId(
        "reyna-page-index-developers-code-example-description-2",
        intl
      ),
...
// https://choosealicense.com/licenses/cc-by-4.0/      
    ...
    {
      title: translateMessageId(
        "reyna-page-index-developers-code-example-title-3",
        intl
      ),
      description: translateMessageId(
        "reyna-page-index-developers-code-example-description-3",
        intl
      ),
      codeLanguage: "language-solidity",
      code: `// SPDX-License-Identifier: MIT
...
contract SimpleDomainRegistry {
  ...
  return (
    <Page>
      <PageMetadata
        title={translateMessageId("reyna-page-index-meta-title", intl)}
        description={translateMessageId(
          "reyna-page-index-meta-description",
          intl
        )}
      />
      <Hero
        fluid={data.hero.childImageSharp.fluid}
        alt={translateMessageId("reyna-page-index-hero-image-alt", intl)}
        loading="eager"
      />
      <Morpher />
      <Header>
        <H1>
          <Translation id="reyna-page-index-title" />
        </H1>
        <Description>
          <Translation id="reyna-page-index-description" />
        </Description>
        <ButtonLink isSecondary to="/what-is-ethereum/">
          <Translation id="reyna-page-index-title-button" />
        </ButtonLink>
      </Header>
      <StyledGrayContainer>
        <StyledContent>
          <IntroRow>
            <IntroLeftColumn>
              <H2>
                <Translation id="reyna-page-index-get-started" />
              </H2>
              <Subtitle>
                <Translation id="reyna-page-index-get-started-description" />
              </Subtitle>
            </IntroLeftColumn>
            <ImageContainer>
              <IntroImage
                ...
                alt={translateMessageId(
                  "reyna-page-index-get-started-image-alt",
                  intl
                )}
              />
            </ImageContainer>
      ...
      <ethereumIntroContainer>
        <RowReverse>
          <FeatureContent>
            <StyledH2>
              <Translation id="reyna-page-index-what-is-reyna" />
            </StyledH2>
            <Subtitle>
              <Translation id="reyna-page-index-what-is-reyna-description" />
            </Subtitle>
            <ButtonRow>
          ...
          <ImageContainer>
            <FeatureImage
              ...
              alt={translateMessageId(
                "reyna-page-index-what-is-reyna-image-alt",
                intl
              )}
            />
          </ImageContainer>
      ...
      <FinanceContainer>
        <Row>
          <FeatureContent>
            <LeftColumnContent>
              <StyledH2>
                <Translation id="reyna-page-index-defi" />
              </StyledH2>
              <Subtitle>
                <Translation id="reyna-page-index-defi-description" />
              </Subtitle>
              <div>
                <ButtonLink to="/defi/">
                  <Translation id="reyna-page-index-defi-button" />
                </ButtonLink>
              </div>
            </LeftColumnContent>
          </FeatureContent>
          <ImageContainer>
            <FeatureImage
              ...
              alt={translateMessageId("reyna-page-index-defi-image-alt", intl)}
            />
          </ImageContainer>
        </Row>
      </FinanceContainer>
        ...
        <Row>
          <ImageContainer>
            <FeatureImage
              ...
              alt={translateMessageId("reyna-page-index-nft-alt", intl)}
            />
          </ImageContainer>
          <FeatureContent>
            <LeftColumnContent>
              <StyledH2>
                <Translation id="reyna-page-index-nft" />
              </StyledH2>
              <Subtitle>
                <Translation id="reyna-page-index-nft-description" />
              </Subtitle>
              <div>
                <ButtonLink to="/nft/">
                  <Translation id="reyna-page-index-nft-button" />
                </ButtonLink>
              </div>
            </LeftColumnContent>
          </FeatureContent>
      ...
      <InternetContainer>
        <Row>
          <FeatureContent>
            <LeftColumnContent>
              <StyledH2>
                <Translation id="reyna-page-index-internet" />
              </StyledH2>
              <Subtitle>
                <Translation id="reyna-page-index-internet-description" />
              </Subtitle>
              <ButtonRow>
                <ButtonLink to="/dapps/?category=technology">
                  <Translation id="reyna-page-index-internet-button" />
                </ButtonLink>
                <StyledButtonLink isSecondary to="/wallets/">
                  <Translation id="reyna-page-index-internet-secondary-button" />
                </StyledButtonLink>
              </ButtonRow>
            </LeftColumnContent>
          </FeatureContent>
          <ImageContainer>
            <FeatureImage
              ...
              alt={translateMessageId(
                "reyna-page-index-internet-image-alt",
                intl
              )}
            />
          </ImageContainer>
      ...
      <DeveloperContainer>
        ...
        <FeatureContent>
          <LeftColumnContent>
            <StyledH2>
              <Translation id="reyna-page-index-developers" />
            </StyledH2>
            <Subtitle>
              <Translation id="reyna-page-index-developers-description" />
            </Subtitle>
            <ButtonRow>
              <ButtonLink to="/developers/">
                <Translation id="reyna-page-index-developers-button" />
              </ButtonLink>
            </ButtonRow>
          </LeftColumnContent>
        </FeatureContent>
      ...
      <StyledGrayContainer>
        <StyledContent>
          <h2>
            <Translation id="reyna-page-index-network-stats-title" />
          </h2>
          <Subtitle>
            <Translation id="reyna-page-index-network-stats-subtitle" />
          </Subtitle>
        </StyledContent>
        <StatsBoxGrid />
      </StyledGrayContainer>
      <StyledContent>
        <h2>
          <Translation id="reyna-page-index-touts-header" />
        </h2>
      </StyledContent>
      <StyledContent>
        <StyledCardContainer>
        ...
        <StyledCalloutBanner
          title={translateMessageId(
            "reyna-page-index-contribution-banner-title",
            intl
          )}
          description={translateMessageId(
            "reyna-page-index-contribution-banner-description",
            intl
          )}
          image={data.finance.childImageSharp.fluid}
          maxImageWidth={600}
          alt={translateMessageId(
            "reyna-page-index-contribution-banner-image-alt",
            intl
          )}
        >
          <ButtonRow>
            <ButtonLink to="/en/contributing/">
              <Translation id="reyna-page-index-contribution-banner-button" />
            </ButtonLink>
            <StyledButtonLink
              isSecondary
...
export const query = graphql`
  query {
    ...
    ethereum: file(relativePath: { eq: "what-is-reyna-network.png" }) {
      childImageSharp {
        fluid(maxWidth: 1440) {
          ...GatsbyImageSharpFluid
        }
    ...
    enterprise: file(relativePath: { eq: "the-reyna-network-community.png" }) {
      childImageSharp {
        fixed(width: 320) {
    ...
    finance: file(relativePath: { eq: "contribute-to-reyna-network.png" }) {
      childImageSharp {
        fluid(maxWidth: 600) {
          ...GatsbyImageSharpFluid
        }
    ...
    infrastructurefixed: file(
      relativePath: { eq: "reyna-network-for-enterprises.png" }
    ) {
      childImageSharp {
        fixed(width: 320) {
          ...GatsbyImageSharpFixed
    ...
    merge: file(
      relativePath: { eq: "upgrade-your-reyna-network-knowledge.png" }
    ) {
      childImageSharp {
        fixed(width: 320) {
          ...GatsbyImageSharpFixed
