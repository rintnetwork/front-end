...
const LanguagesPage = () => {
  ...
  const searchString = translateMessageId(
    "reyna-page-languages-filter-placeholder",
    intl
  )
  ...
  return (
    <StyledPage>
      <PageMetadata
        title={translateMessageId("reyna-page-languages-meta-title", intl)}
        description={translateMessageId("reyna-page-languages-meta-desc", intl)}
      />
      <Content>
        <ContentContainer>
          <h1>
            <Translation id="reyna-page-languages-h1" />
          </h1>
          <p>
            <Translation id="reyna-page-languages-p1" />
          </p>
          <p>
            <Translation id="reyna-page-languages-interested" />{" "}
            <Link to="/en/contributing/translation-program/">
              <Translation id="reyna-page-languages-learn-more" />
            </Link>
            .
          </p>
          <h2>
            <Translation id="reyna-page-languages-translations-available" />:
          </h2>
          <Form>
            <StyledInput
              value={keyword}
          ...
          <h2>
            <Translation id="reyna-page-languages-want-more-header" />
          </h2>
          <p>
            <Translation id="reyna-page-languages-want-more-paragraph" />{" "}
            <Link to="/en/contributing/translation-program/">
              <Translation id="reyna-page-languages-want-more-link" />
            </Link>
            .
          </p>
        </ContentContainer>
