...
const getValidChildrenForCodeblock = (child) => {
  try {
    ...
    * <Codeblock codeLanguage="language-js">
        const web3 = new Web3("wss://rey-mainnet.ws.alchemyapi.io/ws/your-api-key"){"\n"}
        web3.rey.getBlockNumber().then(console.log)
      </Codeblock>
    * */
...
const Codeblock = ({
  ...
  const theme = themeContext.isDark ? codreyeme.dark : codreyeme.light
  return (
    <Container>
      <HightlightContainer
