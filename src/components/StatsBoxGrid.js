...
const StatsBoxGrid = () => {
  ...
  const metrics = [
    ...
    },
    {
      ...
      title: (
        <Translation id="reyna-page-index-network-stats-tx-day-description" />
      ),
      description: (
        <Translation id="reyna-page-index-network-stats-tx-day-explainer" />
      ),
      state: txs,
    },
    {
      ...
      title: (
        <Translation id="reyna-page-index-network-stats-value-defi-description" />
      ),
      description: (
        <Translation id="reyna-page-index-network-stats-value-defi-explainer" />
      ),
      state: valueLocked,
    },
    {
      ...
      title: (
        <Translation id="reyna-page-index-network-stats-nodes-description" />
      ),
      description: (
        <Translation id="reyna-page-index-network-stats-nodes-explainer" />
      ),
      state: nodes,
    },
  ]
