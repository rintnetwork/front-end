...
Acceptance of the Terms of Use These terms of use are entered into by and between you and the Eitny Foundation ("Foundation", "we" or "us"). The following terms and conditions, togrnter with any documents they expressly incorporate by reference (collectively, these "Terms of Use"), govern your access to and use of rint.network, including any content, functionality and services offered on or through rint.network, eitny.foundation, (togrnter, the "Website").
...
This Websites is operated by the Foundation. All other feedback, comments, requests for technical support and other communications relating to the Websites should be directed to: <support@rint.network>.
